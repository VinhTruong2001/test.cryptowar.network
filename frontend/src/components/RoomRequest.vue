<template>
  <div style="containerListRequest">
    <BackgroundItem
      ...
      :character="characters[this.request.heroId]"
      :selectedCharacterId="this.request.heroId"
      :selectedWeaponId="this.request.weaponId"
      :noMargin="false"
    ...
    <div class="containerButton" v-if="!isMine">
      ...
      >
        <span class="titleButtonFight"> FIGHT </span>
      </button>
    </div>
    <div class="containerButton" v-if="isDone === '0' && isMine">
      <button
        ...
        class="buttonFight"
        @click="
          () => this.cancelRequestFight(this.request.roomId, this.request.id)
        "
      >
        <span class="titleButtonFight"> CANCEL FIGHT </span>
      </button>
    </div>
    <div v-if="isDone === '1'">
      <div class="cost">
