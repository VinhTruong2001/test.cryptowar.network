<template>
  <div class="body main-font container">
    <h1>Referral</h1>
    <div>
      🤝 Invite your friends to play Cryptowar when your friend mint new Heroes,
      both of you will share a reward as following:
    ...
    <b-input-group prepend="Your referral link:" class="mt-3 referal-link">
      ...
      <b-input-group-append>
        <b-button @click="copyReferralLink(defaultAccount)">Copy</b-button>
      </b-input-group-append>
    </b-input-group>
  </div>
</template>
